...
// Create 'terms' and 'color' to be handled by garbage collector
- (id)init
{
	[super init];
	// Create a color
	...
	// Put it under control of the garbage collector
...
- (void)drawInRect:(CGRect)b inContext:(CGContextRef)ctx
{
	...
	// Scale and translate coordiante system so drawing in funcRect fills view
	CGAffineTransform transform = CGAffineTransformMake(b.size.width / funcRect.size.width,
														0, 0, b.size.height / funcRect.size.height,
